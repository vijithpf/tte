...
<div class="container lgn-container">
...
<div class="span10">
	<div class="actions sign-in-btn">
	<?php echo $form->submit('submit', t('Login'), array('class' => 'primary'))?>
	</div>
</div>
</div>
</div>
