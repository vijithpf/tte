...
<?php foreach ($pages as $page):
    ...
    $pageUrl = $nh->getLinkToCollection($page);
    $externalUrl = $page->getAttribute('external_url');
    $url = ($externalUrl ? $externalUrl : $pageUrl);
    ...
    <section class="section section_image_content_block left">
        <div class="container">
            <div class="block block_left">
                <div class="block_image full_bg mainImage"
                     style="background-image: url('<?php echo $thumbImage->src; ?>')">
                    <div class="the_block">
                        ...
                        <div class="block_content">
                            <div class="blurred_image_wrap blurWrap right">
                                <div class="blurred_image blurImage"
                                     style="background-image: url('<?php echo $thumbImage->src; ?>');">
                            ...
                            <div class="block_details">
                                ...
                                <?php if($subpageInfo) { ?>
          											...
          											<?php } ?>
                                <a href="<?php echo $url; ?>" title="<?php echo $title; ?>" class="btn btn-md btn-white">See all Products</a>
                            </div>
                    ...
                    <div class="grey_block_content">
                        ...
                        <p><?php echo $description; ?></p>
                            ...
                            <?php if($subpageInfo) { ?>
      											...
      											<?php } ?>
                        <a href="<?php echo $url; ?>" class="btn btn-underline btn-clr-purple" title="<?php echo $title; ?>">Learn More</a>
