...
echo '<ul class="main_nav left">'; //opens the top-level menu

foreach ($navItems as $ni) {

    echo '<li class="' . $ni->classes . '">'; //opens a nav item

    echo '<a href="' . $ni->url . '" target="' . $ni->target . '" class="' . $ni->classes . '"><span>' . $ni->name . '</span></a>';
...
<?php echo '</ul>'; //closes the top-level menu
