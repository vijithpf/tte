...
echo '<div class="breadcrumb-nav">'; //opens the top-level menu
echo '<span class="home-link"><a href="' . View::url('/') . '">Home</a></span>'; ?>
<?php if($page->getAttribute('page_type') == 'about'): ?>
<span><a href="<?php echo View::url('/about'); ?>">About</a></span>
<?php endif; ?>
<?php if($page->getAttribute('page_type') == 'clients'): ?>
<span><a href="<?php echo View::url('/clients'); ?>">Clients</a></span>
<?php endif; ?>
<?php
foreach ($navItems as $ni) {

    echo '<span class="' . $ni->classes . '">'; //opens a nav item
