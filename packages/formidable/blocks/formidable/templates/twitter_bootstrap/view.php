...
<div id="formidable_container_<?php  echo $ff->formID ?>" class="formidable <?php  echo $review?'review':'' ?> <?php  echo $limit_submission?'limit_submission':'' ?> <?php  echo $submission?'submission':'' ?> <?php  echo $schedule?'schedule':'' ?> <?php  echo $error?'error':'' ?> bootstrap container">
	...
	<?php  } else { ?>		
		...
		<?php  } ?>
		<form id="ff_<?php  echo $ff->formID ?>" name="formidable_form" method="post" enctype="multipart/form-data" class="<?php  echo (intval($ff->css)!=0)?$ff->css_value:''?> form-horizontal">
					...
					<div class="formidable_row row">
						...
						<?php 
                            ...
                            foreach($row as $layoutID => $layout) { ?>
                                <div class="formidable_column<?php  echo ($i==(count($row)-1)?' last':''); ?> <?php  echo 'col-md-'.$width; ?>">
                                    <div class="inner">
									<?php  
                                        ...
                                        if(count($layout->elements)) {
                                            foreach($layout->elements as $element) { ?>														
                                                ...
                                                <?php  } else { ?>
                                                	<div class="element control-group <?php  echo $element->element_type; ?> <?php  echo $element->handle; ?>">
                                                        ...
                                                        <?php  } ?>
                                                        <div class="input controls <?php  echo intval($element->label_hide)==0?'has_label':'no_label'; ?>">
                                                            <?php  if ($review) { ?>
                                                        ...
                                                        <?php  if (intval($element->option_other) != 0 && !$review) { ?>																	
                                                            <div class="input controls <?php  echo intval($element->label_hide)==0?'has_label':'no_label'; ?> option_other">													
            ...
            <div class="formidable_row">
				<div class="inner">
					<div class="element control-group">
						...
						<div class="input ccm_formidable_captcha controls">
			...
			<div class="formidable_row">
				<div class="inner">
					<div class="element control-group form-actions">
