...
<div id="formidable_container_<?php  echo $ff->formID ?>" class="formidable <?php  echo $review?'review':'' ?> <?php  echo $limit_submission?'limit_submission':'' ?> <?php  echo $submission?'submission':'' ?> <?php  echo $schedule?'schedule':'' ?> <?php  echo $error?'error':'' ?>">
	...
	<?php  } else { ?>
		...
		<?php  } ?>
		<form id="ff_<?php  echo $ff->formID ?>" name="formidable_form" method="post" enctype="multipart/form-data" class="<?php  echo (!empty($ff->css))?$ff->css_value:''?>">
                                                            ...
                                                            <div class="input <?php  echo intval($element->label_hide)==0?'has_label':'no_label'; ?>">
                                                                <div id="<?php  echo $element->handle ?>_counter" class="counter" type="<?php  echo $element->min_max_type ?>" min="<?php   echo $element->min_value ?>" max="<?php  echo $element->max_value ?>">
                                                                    <?php  if ($element->max_value > 0) { ?>
                                                                        <?php   echo t('You have') ?> <span id="<?php  echo $element->handle ?>_count"><?php  echo $element->max_value ?></span> <?php  echo ($element->min_max_type!='value')?$element->min_max_type:t('characters'); ?> <?php  echo t('left')?>.
                                                                    <?php  } ?>
                                                                </div>
                                                            </div>
                                                        <?php  } ?>
            ...
            <div class="formidable_row captcha_row">
				<div class="inner">
					<div class="element">
