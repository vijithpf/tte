...
if ($controller->hasVoted()) { ?>
	...
	<div style="">		
		...
		<div >
		<img border="" src="//chart.apis.google.com/chart?cht=p&chd=t:<?php echo implode(',', $optionResults)?>&chs=180x180&chco=<?php echo implode(',', $graphColors)?>" alt="<?php echo t('survey results');?>" />
		</div>
		<?php } ?>	
