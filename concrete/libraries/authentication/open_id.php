    ...
    class OpenIDAuth  {
        ...
        public function complete() {
            ...
            if ($response->status == Auth_OpenID_CANCEL) {
                $this->response->code = self::E_CANCEL;
                $this->response->message = $response->message;
            } elseif ($response->status == Auth_OpenID_FAILURE) {
                $this->response->code = self::E_FAILURE;
                $this->response->message = $response->message;
        ...
        public function request($identifier) {
            ...
            if (!$response) {
                $this->response->code = self::E_INVALID_OPENID;
            } else {
                ...
                if (Auth_OpenID::isFailure($this->redirect)) {
                    $this->response->code = self::E_CONNECTION_ERROR;
        ...
        private function translate($response) {
            ...
            if (!is_object($ui)) {
                ...
                if ($val->email($sreg['email'])) {
                    ...
                    if (is_object($ui)) {
                        $this->response->code = self::E_REGISTRATION_EMAIL_EXISTS;
