...
/* vim: set expandtab tabstop=4 shiftwidth=4 softtabstop=4: */
    ...
    class Services_JSON_EncDec_TestCase extends PHPUnit_TestCase {
        ...
        public function Services_JSON_EncDec_TestCase($name) {
        ...
        public function test_to_then_from_JSON()
        {
        ...
        public function test_from_then_to_JSON()
        {
    ...
    class Services_JSON_AssocArray_TestCase extends PHPUnit_TestCase {
        ...
        public function Services_JSON_AssocArray_TestCase($name) {
            $this->PHPUnit_TestCase($name);
        }
    ...
    class Services_JSON_NestedArray_TestCase extends PHPUnit_TestCase {
        ...
        public function Services_JSON_NestedArray_TestCase($name) {
            $this->PHPUnit_TestCase($name);
        }
        ...
        public function _test_from_JSON()
        {
    ...
    class Services_JSON_Object_TestCase extends PHPUnit_TestCase {
        ...
        public function Services_JSON_Object_TestCase($name) {
            $this->PHPUnit_TestCase($name);
        }
    ...
    class Services_JSON_Spaces_Comments_TestCase extends PHPUnit_TestCase {
        ...
        public function Services_JSON_Spaces_Comments_TestCase($name) {
            $this->PHPUnit_TestCase($name);
        }
    ...
    class Services_JSON_Empties_TestCase extends PHPUnit_TestCase {
        ...
        public function Services_JSON_Empties_TestCase($name) {
            $this->PHPUnit_TestCase($name);
        }
    ...
    class Services_JSON_UnquotedKeys_TestCase extends PHPUnit_TestCase {
        ...
        public function Services_JSON_UnquotedKeys_TestCase($name) {
            $this->PHPUnit_TestCase($name);
        }
    ...
    class Services_JSON_ErrorSuppression_TestCase extends PHPUnit_TestCase {
        ...
        public function Services_JSON_ErrorSuppression_TestCase($name) {
            $this->PHPUnit_TestCase($name);
        }
        ...
        public function test_to_JSON_suppressed()
        {
