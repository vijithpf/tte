...
class dbObject {
     ...
     *
     * @return bool TRUE if RDBMS is supported; otherwise returns FALSE.
     */
...
class dbTable extends dbObject {
    ...
    /**
     * @var bool Mark table for destruction
     */
    public $drop_table;

    /**
     * @var bool Mark field for destruction (not yet implemented)
     */
...
class dbIndex extends dbObject {
    ...
    /**
     * @var bool Mark index for destruction
     */
    public $drop = false;
...
class dbQuerySet extends dbObject {
    ...
    /**
     * @var bool Auto prefix enable (TRUE)
     */
...
class adoSchema {
     ...
     *                             the current schema.
     * @param bool  $continueOnErr Continue to apply the schema even if an error occurs.
     ...
     *
     * @return bool TRUE if save is successful, else FALSE. 
     */
     ...
     * in the schema. 
     *
     * @param bool $data Include data in schema dump
     ...
     * @param bool   $underscore If TRUE, automatically append an underscore character to the prefix.
     *
