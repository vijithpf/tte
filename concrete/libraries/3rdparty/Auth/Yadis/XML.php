...
class Auth_Yadis_XMLParser {
     ...
     *
     * @return bool $result True if the initialization and
     ...
     *
     * @return bool $result True if the registration succeeded;
     *              false otherwise.
     */
     ...
     *                           object's XML parser.
     *
     * @return bool $result True if the initialization succeeded;
     *              false otherwise.
     */
