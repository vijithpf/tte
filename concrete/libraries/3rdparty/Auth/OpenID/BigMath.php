...
class Auth_OpenID_MathLibrary {
     ...
     * available.
     *
     * @param int $long The long number (can be a normal PHP
     ...
     *
     * @return int $long The long number equivalent of the binary
     *             string $str
     */
     ...
     * available.
     *
     * @param int $start The start of the range, or the minimum
     *                   random number to return
     * @param int $stop  The end of the range, or the maximum
     *                   random number to return
     * @param int $step  The step size, such that $result - ($step
     *                   * N) = $start for some N
     *
     * @return int $result The resulting randomly-generated number
     */
