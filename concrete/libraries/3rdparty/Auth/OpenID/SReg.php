 ...
 * from the OpenID request using {@link * Auth_OpenID_SRegRequest::fromOpenIDRequest}, gets the user's
 ...
 *
 * 3. The relying party uses {@link * Auth_OpenID_SRegResponse::fromSuccessResponse} to extract the data
