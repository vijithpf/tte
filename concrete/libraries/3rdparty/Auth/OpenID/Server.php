 ...
 * 
 * The first and last of these tasks may performed by the {@link * Auth_OpenID_Server::decodeRequest()} and {@link * Auth_OpenID_Server::encodeResponse} methods.  Who gets to do the
 ...
 * data sent back by your extension to be signed.  {@link * Auth_OpenID_ServerResponse} provides methods with which you can add
 ...
 * on MySQL, SQLite, or PostgreSQL, see the {@link * Auth_OpenID_SQLStore} subclasses.
 *
 * Upgrading
 *
 ...
 *
 * For your convenience, I also provide an interface to {@link * Auth_OpenID_Decoder::decode()} and {@link * Auth_OpenID_SigningEncoder::encode()} through my methods {@link * decodeRequest} and {@link encodeResponse}.
 *
