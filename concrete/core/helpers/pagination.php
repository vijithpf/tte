...
class Concrete5_Helper_Pagination
{
    ...
    public function getNext($linkText = false, $wrapper = 'span')
    {
        if (!$linkText) {
    ...
    public function getPages($wrapper = 'span', $shownElements = 9)
    {
        if ($this->number_of_pages == 1) {
            return;
        }
