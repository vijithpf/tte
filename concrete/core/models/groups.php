...
class Concrete5_Model_GroupList extends Object
{
     ...
     */
    public function __construct($obj, $omitRequiredGroups = false, $getAllGroups = false)
    {
        if ($getAllGroups) {
            $db     = Loader::db();
...
class Concrete5_Model_Group extends Object
{
    ...
    */
     ...
     */
    public function getGroupStartDate($type = 'system')
    {
     ...
     * @return string date formated like: 2009-01-01 00:00:00
     */
    public function getGroupEndDate($type = 'system')
    {
        if (ENABLE_USER_TIMEZONES && $type == 'user') {
            $dh = Loader::helper('date');
