...
class Concrete5_Controller_Block_FormMinisurvey
{
    ...
    public function loadSurvey($qsID, $showEdit = false, $bID = 0, $hideQIDs = array(), $showPending = 0, $forPreview = false)
    {
    ...
    public function loadInputType($questionData, $showEdit, $required = false)
    {
