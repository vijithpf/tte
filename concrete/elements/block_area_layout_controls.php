<div id="ccm-layout-controls-<?php echo intval($layout->cvalID) ?>" class="ccm-layout-controls ccm-layout-controls-layoutID-<?php echo intval($layout->layoutID) ?>">  
	...
	<input id="layout_col_break_points_<?php echo intval($layout->cvalID) ?>" class="layout_col_break_points" name="layout_col_break_points" type="hidden" value="<?php echo htmlspecialchars(implode('|', $layout->breakpoints)) ?>" />
